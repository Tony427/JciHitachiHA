...
- Hitachi Air Conditioner 日立冷氣
  ...
  - Monthly power consumption 月用電統計 (pick the month 1-12 in Power consumption month 用電統計月份, the current month by default; a month later than the current one is last year's)
